...
class CompleteEmailProcessor:
        ...
        if not creds or not creds.valid:
            if creds and creds.expired and creds.refresh_token:
                try:
                    ...
                    print(f"   Re-authenticating with credentials file...")
                    creds = None
            ...
            if not creds:
                ...
                if not os.path.exists(self.credentials_file):
                    ...
                    print(f"   Gmail integration disabled. Payment updates from email will not work.")
                    self.service = None
                    return
    ...
    def fetch_and_process_uob_emails_24h(self):
        ...
        if self.service is None:
            print("🎯 Summary: Gmail service not available. 0 emails processed.")
            return
